...
export type CaseStudyRichDetail = {
  subtitle: string;
  /** Shown in the article body as a short teaser under the subtitle. */
  metaDescription?: string;
  /** SEO `<title>` override (layout still appends `| OnDial` unless absolute). */
  metaTitle?: string;
  /** SEO meta description (preferred over metaDescription / subtitle). */
  seoDescription?: string;
  /** Internal anchor phrases rendered as links inside prose. */
  contentLinks?: CaseStudyTextLink[];
  readMinutes: number;
  domain?: string;
  scale?: string;
...
export const CASE_STUDIES: CaseStudyItem[] = [
  {
    ...
    richDetail: {
      ...
      metaTitle: "AI Voice Agent for Telecom Cuts Call Center Volume by 60%",
      seoDescription:
        "Discover how an AI voice agent for telecom reduced call center volume by 60%, eliminated hold times, and cut operational costs by 40%. Read the full case study.",
      contentLinks: [
        {
          text: "AI Voice Agents for Telecommunications",
          href: "/industries/ai-voice-agents-telecommunications",
        },
        {
          text: "AI Voice Agents for Call Centers & BPO",
          href: "/industries/ai-voice-agents-call-centers-bpo",
        },
        { text: "Explore All Industries", href: "/industries" },
      ],
      readMinutes: 13,
  ...
  },
  {
    ...
    richDetail: {
      ...
      metaTitle: "Voice AI for Insurance Claims Reduces Agent Load by 70%",
      seoDescription:
        "See how voice AI for insurance claims cut live agent load by 70%, eliminated wait times, and boosted adjuster processing capacity by 60%. Read the case study.",
      contentLinks: [
        {
          text: "AI Call Center Solution",
          href: "/industries/ai-voice-agents-call-centers-bpo",
        },
        { text: "20+ Industries", href: "/industries" },
      ],
      readMinutes: 15,
  ...
  },
  {
    ...
    richDetail: {
      ...
      metaTitle: "Voice AI for Debt Collection Boosts Early EMI Recovery 40%",
      seoDescription:
        "See how Voice AI for debt collection helped an NBFC lift early-stage EMI recovery by 40% while automating 100,000 daily multilingual calls. Read the case study.",
      contentLinks: [
        {
          text: "Finance & Banking AI Voice Agent",
          href: "/industries/ai-voice-agents-finance-banking",
        },
        {
          text: "AI Voice Solutions for 20+ Industries",
          href: "/industries",
        },
        {
          text: "Multilingual AI Voice Agent",
          href: "/multilingual-ai-voice-agent",
        },
        {
          text: "Healthcare AI Voice Solutions",
  ...
  },
  {
    ...
    richDetail: {
      ...
      metaTitle: "AI Appointment Reminders for Healthcare: 42% Fewer No-Shows",
      seoDescription:
        "See how automated appointment reminders for healthcare cut patient no-shows by 42%, recovered 35 staff hours weekly, and boosted same-week reschedules by 18%.",
      contentLinks: [
        {
          text: "AI voice agents for healthcare and medical services",
          href: "/industries/ai-voice-agents-healthcare-medical",
        },
        {
          text: "AI voice agents for insurance",
  ...
  },
  {
    ...
    richDetail: {
      ...
      metaTitle: "AI Voice Agents Reduce Retail Bank Delinquencies by 28%",
      seoDescription:
        "See how AI voice agents automated payment alerts and loan reminders for a retail bank, cutting 30-day delinquencies by 28% and recovering 400 staff hours weekly.",
      contentLinks: [
        {
          text: "AI Voice Agents for Finance & Banking",
          href: "/industries/ai-voice-agents-finance-banking",
        },
        {
          text: "AI voice agents for insurance",
