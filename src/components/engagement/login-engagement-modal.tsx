...
import { PerspectiveMediaGrid } from "@/components/engagement/perspective-media-grid";
...
/** Clear older dismiss keys that used to block the popup. */
...
export function LoginEngagementModal({
  ...
  // Mount + first open strictly 30s after window load.
  useEffect(() => {
